        ...
        collect([
            ...
            [
                ...
                'syarat' => [
                    ...
                    'Surat Izin Penceraian dari atasan bagi PNS, TNI/POLRI bagi yang Termohon dan Pemohon.',
                    'Wajib ada Penetapan Hak Asuh Anak',
                    ...
                    'Membayar Panjar Biaya Perkara',
                    'Melengkapi Berkas Terkait Perkara yang Dikumulasi (Penggugat yang sudah menikah lagi
                    , sudah tidak di akomodir nafkah - nafkah (Iddah & Mutah)',
            ...
            [
                ...
                'syarat' => [
                    ...
                    'FC Kartu Keluarga ',
                    'FC Ijazah Terakhir anak yang di dispensasi (Legalisir di Pos). ',
                    'Surat Keterangan Aktif Sekolah (jika masih sekolah)',
                    'Surat penolakkan dari KUA',
                    // 'Surat Rekomendasi dari Dinas Kesehatan dan P2TP2A',
                    'Surat Keterangan dari Dinas Kesehatan/Puskesmas dan surat rekomendasi DP3A',
                    'Buku Nikah Pemohon Diska',
                    'Persyaratan Permohonan perubahan nama: 1. KTP, 2. Akte Nikah, 3. Akte Kelahiran / KK, 4. Surat Permohonan perubahan nama buku nikah.',
